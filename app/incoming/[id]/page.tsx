  ...
  return (
    <div className="anim-fade-in space-y-4" style={{ maxWidth: 900 }}>
      ...
      <div className="card" style={{ padding: 16 }}>
        <div className="mg">
          <div className="mf">
            <label><Calendar size={12} style={{ verticalAlign: -1 }} /> Дата регистрации</label>
            <span>{new Date(doc.incomingDate).toLocaleDateString("ru-RU")}</span>
          </div>
          <div className="mf">
            <label><Building size={12} style={{ verticalAlign: -1 }} /> Отправитель</label>
            <span>{doc.fromOrg}</span>
          </div>
          <div className="mf">
            <label><User size={12} style={{ verticalAlign: -1 }} /> Зарегистрировал</label>
            <span>
          ...
          {doc.outgoingNumber && (
            <div className="mf">
              <label><FileText size={12} style={{ verticalAlign: -1 }} /> Исходящий</label>
              <span>
                № {doc.outgoingNumber}
          ...
          {deadline && (
            <div className="mf">
              <label><Clock size={12} style={{ verticalAlign: -1 }} /> Срок исполнения</label>
      ...
      {doc.content && (
        <div className="card">
          <div className="ch"><div className="ch-l"><FileText size={14} />Содержание</div></div>
          <div className="cb">
      ...
      {doc.resolution && (
        <div className="card" style={{ borderLeft: "4px solid var(--accent)" }}>
          <div className="ch"><div className="ch-l"><FileText size={14} />Резолюция</div></div>
          <div className="cb">
            ...
            <div className="mg">
              {doc.resolutionAuthor?.employee && (
                <div className="mf">
                  <label><User size={12} style={{ verticalAlign: -1 }} /> Автор</label>
                  <span>
              ...
              {doc.executor && (
                <div className="mf">
                  <label><User size={12} style={{ verticalAlign: -1 }} /> Исполнитель</label>
                  <span>
              ...
              {doc.resolutionDate && (
                <div className="mf">
                  <label><Calendar size={12} style={{ verticalAlign: -1 }} /> Дата</label>
      ...
      {(fileAttachments.length > 0 || doc.fileUrl) && (
        <div className="card">
          <div className="ch"><div className="ch-l"><FileText size={14} />Прикреплённые файлы</div></div>
